...
import '../presentation/routers/router.dart' as _i5;
...
// initializes the registration of main-scope dependencies inside of GetIt
  ...
  _i2.FutureOr<void> init(_i1.GetItHelper gh) async {
    ...
    gh.factory<_i3.Dio>(() => thirdPartyModule.dio);
    gh.factory<_i4.Logger>(() => thirdPartyModule.logger);
    gh.lazySingleton<_i5.BarvRouter>(() => internalModule.barvRouter);
    ...
    gh.lazySingleton<_i9.DevicePlatformInfo>(
      () => _i9.DevicePlatformInfoOther(gh<_i6.PackageInfo>()),
      registerFor: {
        _fuchsia,
        _linux,
        _macos,
